<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="grid grid-flow-row-dense grid-cols-3 grid-rows-3 ">
            ...
            @if($p->user_id == Auth::id() || in_array($p->id, $carts->pluck('product_id')->toArray()))
            @continue
            @endif
            ...
            <div class="px-6 pt-4 pb-2">
                ...
                <form action="{{ route('keranjang.store')}}" method="POST">
                    ...
                    @csrf
                    @method('POST')
                    <input type="hidden" name="product_id" value="{{$p->id}}" class="rounded">
                ...
                <div class="font-bold text-xl mb-2">Sold Out!</div>
                @endif
                </div>
            </div>
